    ...
    <div className="container mx-auto py-12">
      ...
      <div className="flex flex-col md:flex-row gap-12">
        <div className="w-full md:w-1/3">
          <div className="relative w-full aspect-square rounded-lg overflow-hidden bg-muted mb-6">
            <Image
              src="/profile.png"
              alt="ながたかなのプロフィール画像"
              fill
          ...
          <div className="bg-muted p-6 rounded-lg">
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                <span className="font-semibold w-24">名前:</span>
                <span>ながたかな</span>
              </li>
              <li className="flex items-start">
                <span className="font-semibold w-24">活動開始:</span>
                <span>2021年12月</span>
              </li>
              <li className="flex items-start">
                <span className="font-semibold w-24">ジャンル:</span>
                <span>歌ってみた、ボカロカバー</span>
              </li>
            </ul>
          </div>
        </div>
