import { GA_EVENTS, isVideoPlatform } from "@/lib/analyticsConfig";
 ...
 */
export const trackEvent = (eventName: string, eventParams: GA4EventParams = {}): void => {
 ...
 */
export const trackLinkClick = (linkType: string, linkName: string, linkUrl: string): void => {
 ...
 * @param linkUrl The URL of the link
 */
export const trackVideoLinkClick = (platform: string, linkName: string, linkUrl: string): void => {
